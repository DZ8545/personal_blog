<template>
  <div class="panel">
      ...
      <ul class="ul1">
        ...
        <li>
          ...
          <ul>
            <li>
              <router-link
                to="/main/articleType/knowledgeSummary"
                custom
                v-slot="props"
              >
            ...
            <li>
              <router-link
                to="/main/articleType/codeSharing"
                custom
                v-slot="props"
              >
            ...
            <li>
              <router-link
                to="/main/articleType/informalEssay"
                custom
                v-slot="props"
              >
        ...
        <li>
          <i class="iconfont icon-xiaoyouxi" style="font-size: 16px"></i>小游戏
          <ul>
            <li>
            ...
            <li>
              <span>
                <a href="http://chat.dz8545.xyz" target="_blank">dz聊天室</a>
              </span>
            </li>
          </ul>
        </li>
    ...
    <el-drawer v-model="table" direction="rtl" size="250px">
